    ...
    <footer className="bg-background border-t border-border relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16">
          ...
          {/* Brand Column */}
          <div className="md:col-span-5 text-left -mt-8 md:-mt-12">
            <div className="relative h-8 md:h-12 mb-14 md:mb-16">
              <a href="#" className="absolute -left-3 md:-left-4 top-0 z-0">
                <img
                  src={theme === 'dark' ? '/logo-light.png' : '/logo-dark.png'}
                  alt="Codework"
                  className="h-28 md:h-44 w-auto object-contain object-left"
                />
              </a>
            </div>
